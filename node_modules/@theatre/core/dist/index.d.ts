...
declare type SheetObjectAction = (object: ISheetObject, studio: IStudio) => void;
...
export { IProject, IProjectConfig, IRafDriver, ISequence, ISheet, ISheetObject, UnknownShorthandCompoundProps, createRafDriver, getProject, notify, onChange, index_d as types, val };
