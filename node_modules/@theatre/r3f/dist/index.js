...
var RafDriverProvider = ({ driver, children }) => {
  ...
  return /* @__PURE__ */ import_react2.default.createElement(ctx2.Provider, {
...
var createEditable = (config2) => {
  const editable2 = (Component, type) => {
    ...
    return (0, import_react4.forwardRef)((_a, ref) => {
      var _b = _a, {
        theatreKey,
        visible,
        editableType,
      ...
      const storeKey = (0, import_react3.useMemo)(() => makeStoreKey(__spreadProps(__spreadValues({}, sheet.address), {
...
`);
      ...
      return /* @__PURE__ */ import_react4.default.createElement(Component, __spreadProps(__spreadValues({
...
var PerspectiveCamera = editable_default(React5.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React5.createElement("perspectiveCamera", __spreadValues({
...
var OrthographicCamera = editable_default(React6.forwardRef((_a, ref) => {
  var _b = _a, { makeDefault, lookAt } = _b, props = __objRest(_b, ["makeDefault", "lookAt"]);
  ...
  return /* @__PURE__ */ React6.createElement("orthographicCamera", __spreadValues({
    left: size.width / -2,
    right: size.width / 2,
    top: size.height / 2,
